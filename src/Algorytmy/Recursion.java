...
public class Recursion
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println("Factorial: " + recursionTool.getFactorial(7));
	...
	public int getTriangularKonrads(int number)
	{
		if (number == 1)
		{
			return 1;
		...
		{
			int result = number + getTriangularNumR(number - 1);
			System.out.print("Konradowa liczba trujk¹tna to " + result);
			return result;
		}
