package Tutorials4;				// zapisywanie i odczytywanie informacji z bliku tekstowego
...
public class JavaLesson32
{
	...
	public static void main(String[] args)
	{
		...
		PrintWriter custOutput = createFile("C:/java/customers.txt");
	...
	private static void getFileInfo()
	{
		...
		File listOfNames = new File("C:/java/customers.txt");
