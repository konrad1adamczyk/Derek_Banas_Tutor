...
public class JavaLesson19
{
	...
	public static void main(String[] args)
	{
		...
		/*
		 * [ ] Insert characters that are valid [^ ] Insert characters that are
		 * not valid \\s Any white space \\S Any non white space {n,m} Whatever
		 * proceeds must occur between n and m times
		 */
		...
		/*
		 * \\d Any digits 0-9 \\D Anything not a number {n} Whatever proceeds
		 * must occur n times
		 */
		...
		/*
		 * {n,} Whatever proceeds must occur at least n times + Whatever
		...
		/*
		 * \\w Any word type character A-Z, a-z, 0-9, _ \\W Any non word
